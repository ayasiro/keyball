...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                                         CPI_I100, _______  , _______  , _______  , _______  , _______ ,
    _______  , _______  , _______  , SCRL_MO  , _______  , _______  ,                                         CPI_D100  , KC_BTN1  , KC_BTN2  , _______  , _______  , _______  ,
