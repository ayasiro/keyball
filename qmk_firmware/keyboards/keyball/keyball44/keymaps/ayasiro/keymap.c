...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                                        _______  , CPI_I1K  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , SCRL_MO	_______  , _______  , _______  ,                                        CPI_D1K  , KC_BTN1  , KC_BTN2  , _______  , _______  , _______  ,
